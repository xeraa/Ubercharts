...
public class PointSeries extends AbstractSeries<Point[]> {
	private static final long serialVersionUID = 818213777250423853L;
	...
	/**
	 * Sets an array of {@link Point}s to this series to be plotted on the
	 * chart.
	 * 
	 * @param pPoints
	...
	/**
	 * Sets an {@link Collection} of {@link Point}s to this series to be plotted
	 * on the chart.
	 * 
	 * @param pPoints
	 *            an {@link Collection} of {@link Point}s
	 * @return this object for convenient chaining, not a copy
	 * @see Point
	 */
